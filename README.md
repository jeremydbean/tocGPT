...
The login screen now restores the classic ASCII dragon while splashing it with a rainbow gradient and the Times of Chaos (ToC) 2026 tag line. Enable ANSI colors in your MUD client to see the dragon and welcome text in full color.
