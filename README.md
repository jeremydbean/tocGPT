...
The login screen now restores the classic ASCII dragon exactly as it appeared originally, with a rainbow gradient laid over it and a Times of Chaos (ToC) 2026 tag line. Nothing else in the art has changed—enable ANSI colors in your MUD client to see the original dragon in full color with the modernized year stamp.
